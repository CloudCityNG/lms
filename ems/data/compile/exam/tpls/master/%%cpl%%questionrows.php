...
<?php } ?>
 ...
 $qid++; ?>
					        <tr>
								...
								<td>
									<div class="btn-group">
			                    		<a class="btn" href="index.php?exam-master-rowsquestions-rowsdetail&questionid=<?php echo $question['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="子试题列表"><em class="icon-th-list"></em></a>
										<a class="btn" href="index.php?exam-master-rowsquestions-modifyquestion&questionid=<?php echo $question['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="修改"><em class="icon-edit"></em></a>
										<a class="btn confirm" href="index.php?exam-master-rowsquestions-delquestion&questionid=<?php echo $question['qrid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="删除"><em class="icon-remove"></em></a>
			                    	</div>
								</td>
					        </tr>
					        <?php } ?>
