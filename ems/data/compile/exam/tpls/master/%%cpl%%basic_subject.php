					...
					<tr>
						...
						<td>
							<div class="btn-group">
								...
								<a class="btn" href="index.php?exam-master-basic-modifysubject&subjectid=<?php echo $subject['subjectid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="修改课程信息"><em class="icon-edit"></em></a>
								<a class="btn ajax" href="index.php?exam-master-basic-delsubject&subjectid=<?php echo $subject['subjectid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="删除课程"><em class="icon-remove"></em></a>
							</div>
						</td>
					</tr>
					<?php } ?>
