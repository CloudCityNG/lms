...
<div class="row-fluid">
 ...
 $sid++; ?>
			                        ...
			                        <?php break;; ?>
			                        <?php } ?>
			                        <label class="checkbox inline"><input class="q_<?php echo $question['questionid']; ?>" type="checkbox" name="question[<?php echo $question['questionid']; ?>][<?php echo $key; ?>]" rel="<?php echo $question['questionid']; ?>" value="<?php echo $so; ?>" <?php if(in_array($so,$this->tpl_var['sessionvars']['examsessionuseranswer'][$question['questionid']])){ ?>checked<?php } ?>/><?php echo $so; ?> </label>
			                        <?php } ?>
		                        <?php } ?>
		                    </div>
							<?php } else { ?>
...
$(document).ready(function(){
	...
	$('#form1 :input[type=radio]').change(function(){
		//$.post('index.php?exam-app-exam-questionhistory',{rel:$(this).attr('rel'),val:$(this).val()},function(data){
		//	alert(data);
		//});
		var _=this;
		var _this=$(this);
	...
	$('#form1 :input[type=checkbox]').change(function(){
		...
		//$.post('index.php?exam-app-exam-questionhistory',{rel:$(this).attr('rel'),val:formData},function(data){
		//	alert(data);
		//})
		markQuestion(_this.attr('rel'));
	});
