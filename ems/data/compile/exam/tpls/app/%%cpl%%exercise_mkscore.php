...
<div class="row-fluid">
	<div class="container-fluid examcontent">
		<div class="exambox" id="datacontent">
			<form class="examform form-horizontal" id="form1" name="form1" action="index.php?exam-app-exercise-makescore">
				<ul class="breadcrumb">
					<li>
 ...
 $kid++; ?>&nbsp;&nbsp;<?php echo $this->tpl_var['globalknows'][$knowsid['knowsid']]['knows']; ?>&nbsp;<?php } ?></li>
		                    ...
		                    <div class="media-body well">
		                  		【请根据参考答案给出分值】
		                  		<input type="text" name="score[<?php echo $question['questionid']; ?>]" value="" maxvalue="1">
		                  		<span class="text-error">提示：本题共1分，可输入0.5的倍数。</span>
		                  	</div>
						</div>
					</div>
					<?php } ?>
 ...
 $kid++; ?>&nbsp;&nbsp;<?php echo $this->tpl_var['globalknows'][$knowsid['knowsid']]['knows']; ?>&nbsp;<?php } ?></li>
								...
								<div class="media-body well">
			                  		【请根据参考答案给出分值】
			                  		<input type="text" name="score[<?php echo $data['questionid']; ?>]" value="" maxvalue="1">
			                  		<span class="text-error">提示：本题共1分，可输入0.5的倍数。</span>
			                  	</div>
							</div>
							<?php } ?>
