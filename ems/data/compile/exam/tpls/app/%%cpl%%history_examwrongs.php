...
<div class="row-fluid">
 ...
 $qnid++; ?>
	                <?php $tid++; ?>
	                <?php if($this->tpl_var['sessionvars']['examsessionscorelist'][$question['questionid']]  != $this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['questype'][$quest['questid']]['score']){ ?>
	                <?php $wrongnumber++; ?>
