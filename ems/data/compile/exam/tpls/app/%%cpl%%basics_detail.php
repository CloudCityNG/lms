...
<?php } ?>
				...
				<div class="row-fluid">
					...
					<div class="span7">
						<div class="caption">
							...
							<p>&nbsp;</p>
							<p>课程：<?php echo $this->tpl_var['subjects'][$this->tpl_var['basic']['basicsubjectid']]['subject']; ?></p>
							<p>地区：<?php echo $this->tpl_var['areas'][$this->tpl_var['basic']['basicareaid']]['area']; ?></p>
							<p>您现有余额：<?php echo $this->tpl_var['_user']['usercoin']; ?> （<a href="http://sso.51elab.com/debit/recharge.51elab">支付宝充值</a>）</p>
 ...
 $pid++; ?>
										<option value="<?php echo $key; ?>">消费 <?php echo $p['price']; ?>元/<?php echo $p['time']; ?>天</option>
										<?php } ?>
									</select>
								</p>
								<p>
