				...
				<div class="row-fluid">
					...
					<div class="span7">
						<div class="caption">
							...
							<p>&nbsp;</p>
							<p>课程：{x2;$subjects[$basic['basicsubjectid']]['subject']}</p>
							<p>地区：{x2;$areas[$basic['basicareaid']]['area']}</p>
							<p>您现有余额：{x2;$_user['usercoin']} （<a href="http://sso.51elab.com/debit/recharge.51elab">支付宝充值</a>）</p>
							...
							{x2;if:!$basic['basicdemo']}
								...
								<p>
									<select name="opentype" class="input-large">
										{x2;tree:$price,p,pid}
										<option value="{x2;v:key}">消费 {x2;v:p['price']}元/{x2;v:p['time']}天</option>
										{x2;endtree}
									</select>
								</p>
								<p>
