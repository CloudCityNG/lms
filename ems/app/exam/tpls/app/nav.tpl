<div class="row-fluid top">
    ...
    <ul class="nav-user">
        ...
        <li><a href="index.php?exam-app-exam"><em class="icon-user"></em> 我的考试</a></li>
                      {x2;if:$_user['teacher_subjects']}&nbsp;&nbsp;
                      <li> <em class="icon-edit"></em> <a href="index.php?exam-teach">教师管理</a></li>
                      {x2;elseif:$_user['groupid'] == 1}&nbsp;&nbsp;<li><em class="icon-edit"></em> <a href="index.php?core-master">后台管理</a></li>
                      {x2;endif}&nbsp;&nbsp;<li><a href="index.php?user-app-logout" class="noneajax"><em class="icon-lock"></em> 退出</a></li>
                        <li>您好（{x2;$_user['username']}）&nbsp;&nbsp;</li>
	{x2;else}
	<li><a href="index.php?user-app-register">注册</a></li>
                      <li><a href="index.php?user-app-ssologin">登录</a></li>
       {x2;endif}
    </ul>
    </div>
</div>
