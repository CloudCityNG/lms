						...
						<div class="media well">
							...
							<div class="media-body well">
		                    	...
		                    	{x2;if:$questype[v:quest]['questchoice'] == 1 || $questype[v:quest]['questchoice'] == 4}
			                        ...
			                        {x2;eval: break;}
			                        {x2;endif}
			                        <label class="radio inline"><input type="radio" name="question[{x2;v:question['questionid']}]" rel="{x2;v:question['questionid']}" value="{x2;v:so}"  {x2;if:v:question['answerhistory']}{x2;if:v:so == v:question['answerhistory']}{x2;eval: v:jishu++}checked="checked"{x2;endif}{x2;endif}/>{x2;v:so} </label>
			                        {x2;endtree}
		                        ...
		                        {x2;else}
			                        ...
			                        {x2;eval: break;}
			                        {x2;endif}
			                        <label class="checkbox inline"><input type="checkbox" name="question[{x2;v:question['questionid']}][{x2;v:key}]" rel="{x2;v:question['questionid']}" value="{x2;v:so}"  {x2;if:in_array(v:so,$sessionvars['examsessionuseranswer'][v:question['questionid']])}checked{x2;endif}{x2;if:in_array(v:so,v:question['answerhistory'])}{x2;eval: v:jishu++} checked="checked"{x2;endif}/>{x2;v:so} </label>
			                        {x2;endtree}
		                        {x2;endif}
		                    </div>
							{x2;else}
...
$(document).ready(function(){
	...
	$('.yesdonumber').html($('#modal-body .badge-info').length+{x2;v:jishu});
