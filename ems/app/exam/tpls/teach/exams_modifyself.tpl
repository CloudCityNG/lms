	        ...
	        <form action="index.php?exam-teach-exams-modify" method="post" class="form-horizontal">
				...
				<div class="control-group">
					<label class="control-label">考试课程：</label>
				  	<div class="controls">
					  	<select class="combox" needle="needle" min="1" name="args[examsubject]" onchange="javascript:$('#examrulesbox').loadUrl('?exam-teach-exams-ajax&subjectid='+$(this).find('option:selected').val());" id="selectedsubjectid">
				...
				<div class="control-group questpanel panel_{x2;v:questype['questid']}">
					...
					<div class="controls">
						...
						<span class="info">&nbsp;<a class="selfmodal btn" href="javascript:;" data-target="#modal" url="index.php?exam-teach-exams-selectquestions&search[questionsubjectid]={x2;$exam['examsubject']}&search[questiontype]={x2;v:key}&questionids={iselectquestions_{x2;v:key}}&rowsquestionids={iselectrowsquestions_{x2;v:key}}&useframe=1" valuefrom="iselectquestions_{x2;v:key}|iselectrowsquestions_{x2;v:key}">选题</a></span>
