...
{x2;endif}
			<ul class="breadcrumb">
				...
				<li><a href="index.php?{x2;$_app}-teach-questions">试题管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					...
					<ul class="dropdown-menu">
						...
						<li><a href="index.php?{x2;$_app}-teach-questions-bataddquestion&page={x2;$page}{x2;$u}">批量添加</a></li>
					</ul>
				</li>
			</ul>
			<form action="index.php?exam-teach-questions" method="post">
				<table class="table">
					<thead>
		                <tr>
					        <th colspan="2">搜索</th>
