			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					...
					<ul class="dropdown-menu">
						<li><a href="index.php?{x2;$_app}-teach-rowsquestions-addquestionrows&page={x2;$page}{x2;$u}">单题添加</a></li>
						<li><a href="index.php?{x2;$_app}-teach-rowsquestions-bataddquestionrows&page={x2;$page}{x2;$u}">批量添加</a></li>
					</ul>
				</li>
			</ul>
	        <form action="index.php?exam-teach-rowsquestions" method="post">
				<table class="table">
					<tr>
						<td>
							试题ID：
			        ...
			        <tr>
						...
						<td>
			        		<select name="search[questionsubjectid]" class="combox input-medium" target="sectionselect" refUrl="?exam-teach-questions-ajax-getsectionsbysubjectid&subjectid={value}">
	        ...
	        <table class="table table-hover">
	            ...
	            <tbody>
			        ...
			        <tr>
						...
						<td>
							<div class="btn-group">
	                    		<a class="btn" href="index.php?exam-teach-rowsquestions-rowsdetail&questionid={x2;v:question['qrid']}&page={x2;$page}{x2;$u}" title="修改模型信息"><em class="icon-th-list"></em></a>
								<a class="btn" href="index.php?exam-teach-rowsquestions-modifyquestion&questionid={x2;v:question['qrid']}&page={x2;$page}{x2;$u}" title="修改"><em class="icon-edit"></em></a>
								<a class="btn ajax" href="index.php?exam-teach-rowsquestions-delquestion&questionid={x2;v:question['qrid']}&page={x2;$page}{x2;$u}" title="删除"><em class="icon-remove"></em></a>
	                    	</div>
						</td>
			        </tr>
			        {x2;endtree}
