...
{x2;endif}
        	...
        	<form action="index.php?exam-teach-basic-modifybasic" method="post" class="form-horizontal">
				<fieldset>
					...
					<div class="control-group">
						<label for="basicsubjectid" class="control-label">考试课程</label>
						<div class="controls">
							<select id="basicsubjectid" name="args[basicsubjectid]" needle="needle" msg="您必须选择考试课程">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<span class="help-block">免费考场用户开通考场时不扣除费用</span>
						</div>
					</div>
					<div class="control-group">
						...
						<div class="controls">
							<textarea class="input-xlarge" rows="4" name="args[basicprice]" id="basicprice">{x2;$basic['basicprice']}</textarea>
						  	<span class="help-block">请按照“时长:开通所需费用”格式填写，每行一个，时长以天为单位，免费考场此设置无效。</span>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
