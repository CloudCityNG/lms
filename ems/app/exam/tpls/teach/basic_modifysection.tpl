...
{x2;endif}
			<ul class="breadcrumb">
				...
				<li><a href="index.php?{x2;$_app}-teach-basic-section&subjectid={x2;$subjectid}&page={x2;$page}">课程管理</a> <span class="divider">/</span></li>
        	...
        	<form action="index.php?exam-teach-basic-modifysection" method="post" class="form-horizontal">
				<fieldset>
