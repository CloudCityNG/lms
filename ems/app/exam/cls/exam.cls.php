...
class exam_exam
{
	...
	public function getExamSessionBySessionidTemp($sessionid)
	{
	    if(!$sessionid)
	        $sessionid = $this->session->getSessionId();
        $data = array(false,'examsession',array());
        $sql = $this->pdosql->makeSelect($data);
        return $this->db->fetch($sql,array('examsessionquestion','examsessionsign','examsessionsetting','examsessionuseranswer','examsessionscorelist'));
	}
	...
	{
		$data = array(false,'exams',array());
		$sql = $this->pdosql->makeSelect($data);
		return $this->db->fetch($sql,array('examsetting','examquestions'));
	}
	
	public function getExamSettingById_backup($id)
	{
