...
{x2;endif}
			...
			<form action="index.php?exam-master-questions-modifyquestion" method="post" class="form-horizontal">
				...
				<div class="control-group">
					<label for="lesson_video" class="control-label">附件</label>
					<div class="controls">
						<span class="input-append">
							<input type="text" name="args[questionattach]" id="questionattach_value" class="inline uploadvideo" value="{x2;$question['questionattach']}"/>
							<span id="questionattach_percent" class="add-on">0.00%</span>
						</span>
						<span class="btn">
							<a id="questionattach" class="uploadbutton" exectype="upfile" uptypes="*.mp3">选择文件</a>
						</span>
						<span class="help-block">注意：导入文件必须为MP3文件，每个MP3文件请不要超过2M，否则可能导入失败</span>
					</div>
				</div>
				<div class="control-group">
				  	<div class="controls">
