...
?>
            <form name="theForm" method="post" action="tobe_arranged.php">
                <input type="hidden" name="action" value="arrange_save" /> 
                ...
                <table border="0" cellpadding="5" cellspacing="0" align="center" width="100%">
                        <tr class="containerBody">
                                ...
                                <td class="formTableTd" align="left">
                                    ...
                                    <script src="<?=api_get_path ( WEB_JS_PATH )?>js_calendar.js"
                                            ...
                                            onclick="showcalendar(event,this,true,'<?=date ( "Y-m-d H:i" )?>', '<?=date ( 'Y-m-d H:i', strtotime ( "+ 30 days" ) )?>')"
                                            name="finish_date" value="<?=$default_finish_date?>" />
                                </td>
                        </tr>
                        ...
                        <tr class="containerBody">
                                ...
                                <td class="formTableTd" align="left">
                                    <input name="send_mail" value="1" type="radio" id="send_mail1" />
                                    <label for="send_mail1">是</label>&nbsp;
                                    <input name="send_mail" value="0" type="radio" id="send_mail0" checked="checked" />
                                    <label for="send_mail0">否</label>&nbsp;&nbsp;
                                </td>
                        </tr>
