...
function sortTable(id, col, rev,imgid) {
...
if(tblEl.reverseSort[col])
 {
     imgEl.src='../images/up1.gif';
 }
 else
 {
     imgEl.src='../images/down1.gif';
 }
  ...
  for (i = 0; i < tblEl.rows.length - 2; i++) {
    ...
    for (j = i + 1; j < tblEl.rows.length-1; j++) {
...
function setRanks(tblEl, col, rev) {
  ...
  // column.
  while (col > 1 && i >= 0 && i < tblEl.rows.length-1) {
