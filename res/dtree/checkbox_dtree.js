...
function dTree(objName,iconPath) {
	this.config = {
		...
		inOrder					: false,
		useCheckbox:false		//added by wallimn 2009-02-05, to control whether checkbox is showed
	};
	//modified by wallimn 2009-02-05, in order to make client can modify path of icons;
	if(!iconPath)iconPath="../../res/dtree/img/";//set the default value, be compatible with dtree
	this.icon = {
