...
/*
 ...
 ==============================================================================
 */
$export_id=htmlspecialchars($_GET['code']);
...
echo "<div><h3>您确定下载该升级包吗？</h3></div>";

$form = new FormValidator ( 'upload', 'POST','tgz_export.php?code='.$export_id, '', 'enctype="multipart/form-data"' );
$form->createElement('hidden','category','',array('value'=>$export_id));
$group = array ();
...
/** 远程下载 断点续传 end **/
      ...
      $path=$url_path."/storage/coursesnew";
...
//	  exit;
            if($filename1){
            $downfiles="http://".$_SERVER['HTTP_HOST'].URL_APPEDND."/storage/coursesnew/$filename1";
           //usage
