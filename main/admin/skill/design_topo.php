...
$toponame=DATABASE::getval("select  `skill_name`  from  `skill_occupation`  where  `id`=".$occupation_id);
if($action=="design" &&  $occupation_id){
 ...
 ////type=1模板，一模板一设备
  ...
  ////type=2路由
    ...
    foreach ($routers  as  $router){     
        ...
        $picture=URL_APPEDND."/storage/images/devices/".$device_data[0]['picture'].".png";
  ...
  //////type=2,, end 
   ...
   echo    "<div style='text-align: left;font-size: 18px;font-weight: bold;margin-left: 10px;color: rgb(130, 51, 175);'>".$toponame."</div>"; 
}else{
     tb_close();
 }
...
//alert( JSON.stringify(json.nodes));
    ...
    <script type="text/javascript">
        ...
        function exportMap(json) {
            ...
            document.cookie="occupat_id=<?=$occupation_id?>";
            window.location.href="save_topo.php";
        }
        function cleanMap() {
            document.cookie="actionss=cleanMap";
            document.cookie="occupat_id=<?=$occupation_id?>";
            window.location.href="clean_topo.php";
        }
...
//            alert(jsonStr);
            ...
            var sidebarHtml = "",  i;
            sidebarHtml += '<span class="title"><?=$toponame1?></span><br>';
