...
<body>
<div style="float:right;width:100px;margin-right: 5px;"><a href="javascript:window.location.reload();"><?=get_lang('Refresh')?></a>
    ...
    <table cellspacing="5">
        ...
        <tr>
            <td><!--script type=text/javascript>
                ...
                d.add(0,-1,'<?=get_lang ( "PoolManagement" )?>','vmlist_host.php','','List');
                <?php
                foreach ($pool_tree as $pool){
                    $url="../exercice/question_base.php?pool_id=".$pool['id'];
