...
$form->addElement ( 'file', 'FILE1', '上传虚拟光盘镜像:', array ('class' => 'inputText', 'style' => 'width:60%', 'id' => 'upload_file_local' ) );
$form->addElement ( 'html', '<input type="hidden" name="uploaddir" value="'.$upfile.'"><input type="hidden" name="rej_url" value="/lms/main/admin/vmdisk/iso_list.php">');
...
<table class="data_table">
 ...
 <?php
    ...
    for ($i= 0;$i<= count($iso)-1; $i++){
        ...
        echo "<td>$j</td>";
        echo "<td>$iso[$i]</td>";
        echo "<td align=center><a href='iso_list.php?iso=$iso[$i]' target='_self' onclick='aler();'>";
