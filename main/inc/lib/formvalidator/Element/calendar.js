...
Calendar.prototype.show = function (dateControl, popuControl) {
	...
	this.panel.style.top = (xy.y + dateControl.offsetHeight-38) + "px";
...
document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:210px;">');
...
__ci.document.writeln('th.theader {font-weight:normal;background-color:#227ac0;color:#FFFFFF;width:24px;}');
