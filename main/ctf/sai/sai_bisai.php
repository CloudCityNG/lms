...
if( $ids!=''){
    $sql="select matchRewad from $exam_type where id = '".$ids."'";
...
function check_name( $element_value,$exam_type) {
    $sql="select `matchRewad` from ".$exam_type;
...
$form->addElement ( 'textarea', 'matchRewad', '描述', array ('type'=>'textarea','rows'=>'15','cols'=>'80' ) );
