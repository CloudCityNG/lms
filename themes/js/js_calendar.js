...
function get_position(obj_id){
	var r = new Array();
	var offset = $("#"+obj_id).position();
	r['x']=offset.left;
	r['y']=offset.top;
	r['y']=r['y']+5;
	return r;
...
function loadcalendar() {
	s = '';
	s += '<div id="calendar" style="display:none; position:absolute; z-index:100000;width:220px" onclick="doane(event)">';
...
function showcalendar(event, controlid1, addtime1, startdate1, enddate1) {
	...
	var p= get_position(controlid.id);
	document.getElementById('calendar').style.display = 'block';
	document.getElementById('calendar').style.left = p['x']+'px';
	var offset_height=document.getElementById('outerframe')?document.getElementById('outerframe').offsetHeight:-20;
	offset_height += document.getElementById('header')?document.getElementById('header').offsetHeight:0;
	document.getElementById('calendar').style.top	= (p['y']-offset_height)+'px';
	doane(event);
