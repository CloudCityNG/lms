<div class="row-fluid top">
    ...
    <ul class="nav-user">
        ...
        <li><a href="index.php?exam-app-exam"><em class="icon-user"></em> 我的考试</a></li>
                      ...
                      <?php } elseif($this->tpl_var['_user']['groupid'] == 1){ ?>&nbsp;&nbsp;<li><em class="icon-edit"></em> <a href="index.php?core-master">后台管理</a></li>
                      <?php } ?>&nbsp;&nbsp;<li><a href="index.php?user-app-logout" class="noneajax"><em class="icon-lock"></em> 退出</a></li>
