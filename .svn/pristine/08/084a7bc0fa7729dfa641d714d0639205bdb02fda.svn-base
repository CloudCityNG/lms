...
require_once ('../../../main/inc/header.inc.php');
...
<style type="text/css">
    .data_table .row_odd th,.data_table .row_odd th{color:#000}
     .data_table{width: 84.3%;float: right;}
</style>
...
<section id="main" class="column">
    <h4 class="page-mark">当前位置：<a href="<?=URL_APPEDND;?>/main/admin/index.php">平台首页</a> &gt; <a href="<?=URL_APPEDND;?>/main/admin/cloud_menu.php">云平台</a> &gt; 云桌面存储空间 </h4>
...
echo '<div class="actions" style="width:84%;float:right;">';
