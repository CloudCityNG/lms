...
<?php } ?>
			<ul class="breadcrumb">
				...
				<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-basic-section&subjectid=<?php echo $this->tpl_var['subjectid']; ?>&page=<?php echo $this->tpl_var['page']; ?>">课程管理</a> <span class="divider">/</span></li>
