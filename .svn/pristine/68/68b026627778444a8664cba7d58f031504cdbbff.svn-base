...
<body oncontextmenu="return false" style="margin-left:0px;margin-top:0px;">
<div id="body">
<?php
    if($step_num==0){
        echo "<p align=center>该课程暂时还没有模拟仿真实验.</p>";
    }else{
        ?>
	<div id="leftDiv">
		<img id="cImg" style="z-index: 0;" width="800px" height="603px" usemap="#demo" onmousemove="show_coords(event)">
		<map id="demo" name="demo">
		   <area id="rectHotArea" shape="rect" coords="" style="border:solid 0px red;" href="#" >
		</map>
		<div id="msgDiv"></div>
	...
	<div id="rightDiv">
		<ul></ul><!--
        x: <input id="x1" type="text" size="5"> <br>
        y: <input id="y1" type="text" size="5"><br>
        <button id="controlBtn">set xy</button>-->
	</div>
        </div>
    <!--end-->
<?php
