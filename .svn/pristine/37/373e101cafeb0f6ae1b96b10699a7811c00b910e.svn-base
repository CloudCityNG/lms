...
$files1 = glob($paths."/coursescur/".$category_id.'_*_readme');
...
echo '<caption align="top"><b>当前课件升级包信息</b></caption>
        <tr>
   ...
   echo ' <tr> <td colspan="10" align="center"  style="border-left: 1px dotted #e1e1e1; border-right: 1px dotted #e1e1e1; border-bottom: 1px dotted #e1e1e1; background-color: #F7F7F7 !important; border-right: none !important; font-weight: 500; height: 40px;"><b>没有当前课件升级包信息！</b></td> </tr>';
}
echo '</table>'; 
?>