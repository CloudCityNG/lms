...
<?php
    ...
    function StoreData(data,storetotaltime) {
        ...
        result = DoRequest(myRequest,"<?php echo WEB_SCORM_URL; ?>datamodel.php","id=<?php echo ($id) ?>&sesskey=<?php echo ($USER->sesskey) ?>"+datastring);
...
if (DEBUG_MODE) {
    include_once('debug.js.php');
    echo 'AppendToLog(" SCORM 1.2 API Loaded, Activity: '.$scorm->name.', SCO: '.$sco->identifier.'", 0);';
}
 ?>
