...
{x2;endif}
	        ...
	        <form action="?exam-master-exams-autopage" method="post" class="form-horizontal">
				...
				<div class="control-group">
					<label class="control-label" for="content">考试课程：</label>
				  	<div class="controls">
					  	<select class="combox" needle="needle" min="1" name="args[examsubject]" msg="请选择课程" onchange="javascript:loadsubjectsetting(this);">
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="sortable btn-group">
							...
							<a class="btn questpanel panel_{x2;v:questype['questid']}">{x2;v:questype['questype']}<input type="hidden" name="args[examsetting][questypelite][{x2;v:questype['questid']}]" class="questypepanelinput" id="panel_{x2;v:questype['questid']}" value="1"/></a>
							{x2;endtree}
						</div>
