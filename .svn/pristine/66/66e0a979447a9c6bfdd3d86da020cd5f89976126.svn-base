...
<?php } ?>
 ...
 $kid++; ?>
					<tr>
						...
						<td>
							<div class="btn-group">
								<a class="btn ajax" href="index.php?exam-master-basic-output&knowsid=<?php echo $know['knowsid']; ?>&page=<?php echo $this->tpl_var['page']; ?><?php echo $this->tpl_var['u']; ?>" title="导出题库"><em class="icon-download-alt"></em></a>
