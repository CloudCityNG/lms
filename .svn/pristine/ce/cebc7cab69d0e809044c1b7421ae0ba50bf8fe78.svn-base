						...
						<div class="media well">
							...
							<div class="media-body well">
		                        ...
		                        {x2;else}
			                        ...
			                        {x2;eval: break;}
			                        {x2;endif}
			                        <label class="checkbox inline"><input class="q_{x2;v:question['questionid']}" type="checkbox" name="question[{x2;v:question['questionid']}][{x2;v:key}]" rel="{x2;v:question['questionid']}" value="{x2;v:so}" {x2;if:in_array(v:so,$sessionvars['examsessionuseranswer'][v:question['questionid']])}checked{x2;endif}/>{x2;v:so} </label>
			                        {x2;endtree}
		                        {x2;endif}
		                    </div>
							{x2;else}
