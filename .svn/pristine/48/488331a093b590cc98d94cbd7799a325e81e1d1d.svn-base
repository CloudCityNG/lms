...
?>
            ...
            <section id="main" class="column">
                     ...
                     <div class="cloud-menu boxPublic">
                         ...
                         <a href="<?=URL_APPEND?>main/admin/cloud/cloud_plan.php" title="弹性云计算调度" class="cp m5">弹性云计算调度</a>
                         ...
                         <a href="<?=URL_APPEND?>main/admin/vmmanage/vmdisk_log_list.php" title="虚拟机日志" class="cp m10">虚拟机日志</a>
                     </div>
         </section>   
</body>
</html>