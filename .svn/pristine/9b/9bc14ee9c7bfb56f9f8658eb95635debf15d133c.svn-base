...
{x2;endif}
			<ul class="breadcrumb">
				...
				<li><a href="index.php?{x2;$_app}-teach-basic-subject">课程管理</a> <span class="divider">/</span></li>
				<li><a href="index.php?{x2;$_app}-teach-basic-section&subjectid={x2;$section['sectionsubjectid']}&page={x2;$page}">章节管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
					<a href="index.php?exam-teach-basic-addpoint&sectionid={x2;$section['sectionid']}&page={x2;$page}{x2;$u}">添加知识点</a>
				</li>
			</ul>
	        <form action="index.php?exam-teach-basic-addpoint" method="post" class="form-horizontal">
				<fieldset>
