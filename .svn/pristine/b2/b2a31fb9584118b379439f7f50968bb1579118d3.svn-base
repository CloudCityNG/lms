...
function get_sqlwhere() {
	...
	if (is_not_blank ( $_GET ['pool_id'] )) {
		$sql .= " AND pool_id='" . Database::escape_string ( getgpc ( 'pool_id', 'G' ) ) . "'";
	}
...
<!--        <span class="searchtxt"><img src="images/question_add.gif" align="absmiddle">  <a href="#">简答题</a></span>-->
        ...
        echo link_button ( 'backup.gif', 'ImportQuestions', 'question_base_import.php?pool_id=' . getgpc ( 'pool_id', 'G' ), '50%', '70%', TRUE, TRUE );
