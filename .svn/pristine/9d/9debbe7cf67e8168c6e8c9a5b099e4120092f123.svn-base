...
<div class="row-fluid">
                ...
                <div>
                	...
                	<div class="span8">
                		<div><b class="text-info">考试详情：</b></div>
              			<p>总分：<b class="text-warning">100</b>分 合格分数线：<b class="text-warning">60</b>分 答卷耗时：<b class="text-warning"><?php echo $this->tpl_var['sessionvars']['examsessiontime']; ?></b>分钟</p>
 ...
 $nid++; ?>
                          ...
                          <tr>
                            ...
                            <td><?php echo number_format($num*($this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['questype'][$key]['score']?$this->tpl_var['sessionvars']['examsessionsetting']['examsetting']['questype'][$key]['score']:1),1); ?></td>
                            <td><?php echo number_format($this->tpl_var['score'][$key],1); ?></td>
                          </tr>
                          <?php } ?>
                          <?php } ?>
                          <tr>
                            <td colspan="5" align="left">本次考试共<b class="text-warning"><?php echo $this->tpl_var['allnumber']; ?></b>道题，总分<b class="text-warning">100</b>分，您做对<b class="text-warning"><?php echo $this->tpl_var['allright']; ?></b>道题，得到<b class="text-warning"><?php echo $this->tpl_var['sessionvars']['examsessionscore']; ?></b>分</td>
                          </tr>
                       </table>
