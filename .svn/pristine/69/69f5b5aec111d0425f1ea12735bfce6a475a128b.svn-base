...
{x2;endif}
			<ul class="breadcrumb">
				...
				<li><a href="index.php?{x2;$_app}-master-basic-section&subjectid={x2;$section['sectionsubjectid']}">章节管理</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="pull-right">
					<a href="index.php?exam-master-basic-addpoint&sectionid={x2;$section['sectionid']}{x2;$u}">添加知识点</a>
				</li>
			</ul>
