...
/// Required files
    require_once(api_get_path(LIB_PATH).'/typo3/class.t3lib_cs.php');
    require_once(api_get_path(LIB_PATH).'/typo3/class.t3lib_div.php');
...
/// Default mask for Typo
    $GLOBALS['TYPO3_CONF_VARS']['BE']['fileCreateMask'] = $_configuration["directorypermissions"];

/// This full path constants must be defined too, transforming backslashes
/// to forward slashed beacuse Typo3 requires it.
    define ('PATH_t3lib', str_replace('\\','/',api_get_path(LIB_PATH).'typo3/'));
    define ('PATH_typo3', str_replace('\\','/',api_get_path(LIB_PATH).'typo3/'));
