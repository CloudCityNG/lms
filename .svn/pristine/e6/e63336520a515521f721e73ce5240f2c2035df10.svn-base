...
$form->addElement ( 'file', 'user_upload', '<span style="float:right">上传系统文件</span>', array ('class' => 'inputText', 'style' => 'width:30%', 'id' => 'upload_file_local' ) );
...
if ($form->validate ()) {
    ...
    exec("cd $dir ; /sbin/cloudenc.sh d $fname  ");
