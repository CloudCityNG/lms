...
<?php } ?>
			<ul class="breadcrumb">
				...
				<li><a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-users">开通考场</a> <span class="divider">/</span></li>
			...
			<ul class="nav nav-tabs">
				...
				<li class="dropdown pull-right">
					<a href="index.php?<?php echo $this->tpl_var['_app']; ?>-master-users">开通考场</a>
				</li>
			</ul>
