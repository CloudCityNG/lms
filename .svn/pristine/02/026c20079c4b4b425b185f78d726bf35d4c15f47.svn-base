...
<?php } ?>
 ...
 $uid++; ?>
	            	<tr>
						...
						<td>
						  	<div class="btn-group">
	                    		<a class="btn" href="index.php?exam-master-users-basics&userid=<?php echo $user['userid']; ?><?php echo $this->tpl_var['u']; ?>" title="开通考场"><em class="icon-th-list"></em></a>
							</div>
						</td>
	                </tr>
	                <?php } ?>
