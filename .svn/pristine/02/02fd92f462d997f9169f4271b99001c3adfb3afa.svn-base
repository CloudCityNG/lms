...
function open_modal_dialog(MODULE_ID,TO_ID, TO_NAME,FORM_NAME,URL_APPEND,width,height){
	URL=URL_APPEND+"MODULE_ID="+MODULE_ID+"&TO_ID="+TO_ID+"&TO_NAME="+TO_NAME+"&FORM_NAME="+FORM_NAME;
  loc_y=loc_x=200;
  if(is_ie)
  {
...
function select_data(MODULE_ID,TO_ID, TO_NAME,FORM_NAME,URL_APPEND){
	open_modal_dialog(MODULE_ID,TO_ID, TO_NAME,FORM_NAME,URL_APPEND,720,420);
}

function select_data1(MODULE_ID,TO_ID, TO_NAME,FORM_NAME,URL_APPEND){
	open_modal_dialog(MODULE_ID,TO_ID, TO_NAME,FORM_NAME,URL_APPEND,300,400);
}
...
function SelectUser(MODULE_ID,TO_ID, TO_NAME, FORM_NAME,MANAGE_FLAG,URL_APPEND)
{
  URL=URL_APPEND+"/commons/user_select?MODULE_ID="+MODULE_ID+"&TO_ID="+TO_ID+"&TO_NAME="+TO_NAME+"&FORM_NAME="+FORM_NAME;
  loc_y=loc_x=200;
  if(is_ie)
  {
...
function SelectUserSingle(MODULE_ID,TO_ID, TO_NAME, MANAGE_FLAG, FORM_NAME,URL_APPEND)
{
  URL=URL_APPEND+"/commons/user_select_single.php?MODULE_ID="+MODULE_ID+"&TO_ID="+TO_ID+"&TO_NAME="+TO_NAME+"&FORM_NAME="+FORM_NAME;
  loc_y=loc_x=200;
  if(is_ie)
  {
     loc_x=document.body.scrollLeft+event.clientX-100;
...
{
  URL=URL_APPEND+"/commons/dept_select.php?MODULE_ID="+MODULE_ID+"&TO_ID="+TO_ID+"&TO_NAME="+TO_NAME+"&PRIV_OP="+PRIV_OP;
  loc_y=loc_x=200;
  if(is_ie)
  {
     loc_x=document.body.scrollLeft+event.clientX-100;
...
{
  URL=URL_APPEND+"/commons/dept_select_single.php?MODULE_ID="+MODULE_ID+"&TO_ID="+TO_ID+"&TO_NAME="+TO_NAME+"&PRIV_OP="+PRIV_OP;
  loc_y=loc_x=200;
  if(is_ie)
  {
     loc_x=document.body.scrollLeft+event.clientX-100;
...
function iframeAutoFit(){
	...
	try
	{
		//if(window!=parent)
		{
		    var parentHeight = screen.availHeight - 245;		    
...
function string_count(obj,max,v){
			...
			if(str.length>max){
				...
				obj.value=strr.join('');
				if(v !=null) v.innerHTML=0; // 剩余数量
			}else{
				if(v !=null) v.innerHTML=max-str.length;// 剩余数量
			}
}
