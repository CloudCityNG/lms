	        ...
	        <form action="index.php?exam-master-exams-temppage" method="post" class="form-horizontal">
				...
				<div class="control-group">
					<label class="control-label">考试课程：</label>
				  	<div class="controls">
					  	<select class="combox" autocomplete="off" id="selectedsubjectid" msg="请选择课程" needle="needle" min="1" name="args[examsubject]" onchange="javascript:loadsubjectsetting(this);">
