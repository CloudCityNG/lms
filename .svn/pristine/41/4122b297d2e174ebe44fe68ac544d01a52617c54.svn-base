...
/**
 ==============================================================================
 * This is the text library for ZLMS.
...
function format_locale_date($dateFormat, $timeStamp = -1) {
	...
	$MonthsShort = array (get_lang ( "JanuaryShort" ),
								get_lang ( "FebruaryShort" ),
								get_lang ( "MarchShort" ),
								get_lang ( "AprilShort" ),
								get_lang ( "MayShort" ),
								get_lang ( "JuneShort" ),
								get_lang ( "JulyShort" ),
								get_lang ( "AugustShort" ),
								get_lang ( "SeptemberShort" ),
								get_lang ( "OctoberShort" ),
								get_lang ( "NovemberShort" ),
								get_lang ( "DecemberShort" ) );
	// Defining the months of the year to allow translation of the months
	$MonthsLong = array (get_lang ( "JanuaryLong" ),
...
function text_filter($input, $filter = true) {
	...
	if ($filter == true) {
		...
		// *** parse [?]...[/?] tags *** //
		// for the glossary tool (see http://www.ZLMS.com/extensions)
